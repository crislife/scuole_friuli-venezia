...
# Use the PHP Simple HTML DOM Parser to extract <td> tags
 $main_url="http://www.trampi.istruzione.it/ricScu/cerca.do?";   
     ...
     foreach($prov_friuliv as $prov){
                 $url=$main_url."regione=FRIULI-VENEZIA%20&provincia=".$prov."&comune=&tipologia=".$tipo."&denominazione=&codicemecc=&order=DES_NOM";
                     print $url."\n";
